...
const PROXIED_PREFIXES = ["/admin", "/firm", "/evidence", "/controls", "/gaps", "/tasks", "/requests", "/audit", "/analytics", "/health", "/notifications", "/export", "/activity", "/glossary", "/connectors", "/breach-events", "/rights-requests"];
